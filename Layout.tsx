...
const getLinks = (role: UserRole): NavigationItem[] => {
  ...
  const allLinks: NavigationItem[] = [
    ...
    { name: 'menu_events', page: 'Events', icon: Users, roles: ['admin', 'leader', 'evangelist', 'intercessor'] }, // Evangelismo
    { name: 'menu_global_events', page: 'GlobalEvents', icon: Calendar, roles: ['admin', 'leader', 'evangelist', 'intercessor'] }, // New General Events
...
export const Layout: React.FC<LayoutProps> = ({ children, currentPage, setPage, user, logout }) => {
